...
call cruise_arriving('pn_16');
call cruise_arriving('dy_61');
call cruise_arriving('nw_20');
call magic44_query_check_and_run(22); -- crew
call magic44_query_check_and_run(15); -- passenger
call magic44_query_check_and_run(20); -- cruise
call magic44_query_check_and_run(16); -- person_occupies
...
call cruise_departing('');
call cruise_departing('rc_10');
call magic44_query_check_and_run(20); -- cruise
call magic44_query_check_and_run(16); -- person_occupies
...
(320,32,'cop#sha#1#ship_24#nw_20#11:00:00#11:00:00#4#4#8#p10,p15,p7,p9,p33,p34,p35,p36####'),
(320,32,'mia#nsu#1#ship_1#rc_10#08:00:00#08:00:00#3#4#7#p1,p12,p2,p21,p22,p23,p24####'),
...
(380,35,'usa#9#cnl,egs,gvn,las,mia,nos,sea,sjn,tmp#portcanaveral,porteverglades,portofgalveston,portoflosangeles,portofmiami,portofneworleans,portofsanjuan,portofseattle,portoftampabay###########'),
